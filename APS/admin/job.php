...
if(isset($_POST['searchquery'])){
  $sql= "SELECT * FROM tbl_jobapplication WHERE jobtitle LIKE '%".$_POST['searchquery']."%' ";
}else{
...
<section class="page-content">
    ...
    <div class="search">
      ...
      <a href="job.php?reset=1">Reset</a>
    </form>
...
foreach ($jobs as $job)
{
    echo "
       ...
       " . $job['employer'] . "
        ...
        <td>
       " . mb_strimwIdth($job['jobtitle'], 0, 20, "...") . "
        </td>

        <td>
       " . mb_strimwIdth($job['details'], 0, 50, "...") . "
        </td>
        <td>
  <div class='dropdown'>
...
<button type='button' class='btn btn-link' data-toggle='modal' data-target='#edit".$job['Id']."Modal'>
  Edit Job
</button>
  ...
  <!-- Modal -->
<div class='modal fade' Id='edit".$job['Id']."Modal' tabindex='-1' role='dialog' aria-labelledby='#edit".$job['Id']."ModalLabel' aria-hIdden='true'>
  <div class='modal-dialog' role='document'>
    <div class='modal-content'>
      <div class='modal-header'>
        <h5 class='modal-title' Id='edit".$job['Id']."ModalLabel'>Edit Job</h5>
        ...
        <input type='hIdden' name='Id' value='".$job['Id']."'>
              <div class='form-group'>
                <label for='jobtitle'>Job Title</label>
                  <input type='text' class='form-control' Id='jobtitle' placeholder='Enter JobTitle' name='jobtitle' value='".$job['jobtitle']."' required>
                </div>
                <div class='form-group'>
                  <label for='companyname'>Company Name</label>
                    <textarea class='form-control' Id='companyname' rows='3' placeholder='Enter CompanyName' name='companyname' required>".$job['companyname']."</textarea>
                  </div>

                  <div class='form-group'>
                <label for='employer'>Employer</label>
                  <input type='text' class='form-control' Id='employer' placeholder='Enter Employer' name='employer' value='".$job['employer']."' required>
                </div>
                <div class='form-group'>
                  <label for='details'>Add Details:</label>
                    <textarea class='form-control' Id='details' name='details' value='".$job['details']."' required></textarea>
                      </div>
