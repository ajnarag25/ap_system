<?php 
    ...
    $mail->Body = 'Good day,'. " ".$email.". "."We would like to inform that this student ".$student_name." "."successfully submitted his/her form kindly see attached file. Thank you and have a nice day";
